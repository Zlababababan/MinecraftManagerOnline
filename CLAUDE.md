...
## État (maj 2026-08-21)
- **Fait** : planification complète — docs 01 à 07 rédigés et committés (3 commits, branche main). Aucun code écrit.
- **Prochaine étape** : Phase 0 = 3 spikes de validation (doc 03 §10 : EOF stdin sur vrais serveurs, monitoring Win11 24H2 sans wmic, zstd dans Node 24 ; résultats → `docs/spikes/`, amender docs 03/05/06 si contredits) puis Phase 1 = init monorepo pnpm + Turborepo + CI 4 OS + CONTRIBUTING.md (doc 03 §2, doc 07 phase 1).
- **Dérogations aux docs** : aucune à ce jour.
