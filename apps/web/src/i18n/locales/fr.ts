...
export const webFr = {
  ...
  install: {
    ...
    versionRequired: 'Choisissez une version.',
    versionHint:
      'Les versions viennent de Mojang, et pour Fabric de meta.fabricmc.net. Seules les versions supportées par le chargeur choisi sont proposées.',
    snapshot: 'instable',
    loaderVanilla: 'Vanilla',
    loaderFabric: 'Fabric',
    maxRam: 'Mémoire maximale (Mio)',
    maxRamHint:
      'Un serveur vanilla se contente de 2 à 4 Gio ; un serveur moddé en demande davantage.',
    motd: 'Message d’accueil (MOTD)',
    port: 'Port de jeu',
    eula: 'J’accepte le contrat de licence de Minecraft (EULA) au nom de ce serveur.',
    problemPath: 'Le dossier existe déjà et n’est pas vide.',
    problemPort: 'Le port de jeu est déjà utilisé sur cette machine.',
    problemJava: 'Aucun Java adapté sur la machine : installez-le depuis la page de la machine.',
    problemDisk: 'Il n’y a peut-être pas assez de place sur le disque.',
    retry: 'Reprendre l’installation',
    failedHint: 'L’installation a échoué. Reprenez-la, ou supprimez le serveur.',
  },
