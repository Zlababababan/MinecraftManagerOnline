...
<#
    ...
    https://github.com/Griefed/ServerPackCreator/blob/8.0.7/serverpackcreator-api/src/main/resources/de/griefed/resources/server_files/default_template.ps1
...
Write-Host "Start script generated by ServerPackCreator 8.0.7."
